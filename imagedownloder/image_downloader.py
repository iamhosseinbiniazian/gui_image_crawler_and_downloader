...
import imagedownloder.crawler as crawler
import imagedownloder.downloader as downloader
import sys
def main(argv,classname,keyword,numimg,logger,pbar):
    ...
    parser.add_argument("--numImage", type=int, default=500,
    ...
    numImage=numimg
    crawled_urls = crawler.crawl_image_urls(keyword,logger,
    ...
    downloader.download_images(logger,image_urls=crawled_urls, dst_dir=args.output,
...
#     templist = []
#     tags = []
#     with io.open('imagedownloder/Tag.csv', encoding='utf-8') as csvDataFile:
...
#     with io.open('imagedownloder/OK.txt', 'r', encoding='utf8') as f:
#         lines = f.readlines()
#     tagok = list()
#     for line in lines:
...
#     print(finaltag)
#     with io.open('imagedownloder/OK.txt', 'a+', encoding='utf8') as fff:
